#!/usr/bin/env python3
"""
Direct parser smoke test (docling).

This script intentionally calls the real parser registry in app code instead of
delegating to test_document_parsers.py, so behavior stays aligned with runtime.
"""
